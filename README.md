...
All phase outputs are saved to `chain_state.json` in the working directory. Delete it to start fresh. Use `status` to inspect current state without running anything.
