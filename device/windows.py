...
class Windows(Device):
    def __init__(self, logger, os, device_name, deviceid, uid, tenant, prt, session_key, proxy):
        ...
        # ── enrollment SOAP context items (spoofable via device profile) ──────
        self.hw_dev_id_enroll  = '0' * 64
        self.mac_address       = '00-00-00-00-00-00'
        self.os_edition_enroll = '72'       # Enterprise
        self.locale            = 'en-US'

        # ── SyncML OMA-DM inventory (spoofable via device profile) ───────────
        self.manufacturer      = 'Microsoft Corporation'
        self.model             = 'VMware7.1'
        self.firmware_ver      = 'VMW71.00V.00000000.000.0000000000'
        self.hw_version        = 'Hyper-V UEFI Release v4.0'
        self.device_type_str   = 'VMware 7.1'
        self.oem               = 'Microsoft Corporation'
        self.os_platform       = 'Windows 10 Enterprise'
        self.proc_arch         = '9'            # 9 = AMD64
        self.hw_dev_id_syncml  = 'A' * 64
        self.os_edition_syncml = '4'            # Enterprise
        self.bitlocker_status  = 2              # 2 = encrypted (BitLocker/Status CSP — self-reported, NOT HAS-attested)

        # ── Compliance CSP (DeviceStatus + Defender, self-reported via SyncML) ─
        self.encryption_compliance  = '1'       # 1 = compliant (generic encryption check)
        self.firewall_status        = '0'       # 0 = on and monitoring
        self.av_status              = '0'       # 0 = on and monitoring
        self.av_signature_status    = '0'       # 0 = up to date
        self.antispyware_status     = '0'       # 0 = on and monitoring
        self.antispyware_sig_status = '0'       # 0 = up to date
        self.tpm_version            = '2.0'     # TPM present
        self.secure_boot_state      = '1'       # 1 = enabled (DeviceStatus path, not HAS)
        self.defender_enabled           = 'true'
        self.defender_version           = '4.18.24090.11'
        self.defender_sig_out_of_date   = 'false'
        self.defender_rtp_enabled       = 'true'
        self.aad_user_token             = None   # set via -r to register primary user
            ...
            <wst:RequestSecurityToken>
                ...
                <ac:AdditionalContext xmlns="http://schemas.xmlsoap.org/ws/2006/12/authorization">
                    ...
                    <ac:ContextItem Name="HWDevID">
                        <ac:Value>{self.hw_dev_id_enroll}</ac:Value>
                    </ac:ContextItem>
                    ...
                    <ac:ContextItem Name="OSEdition">
                        <ac:Value>{self.os_edition_enroll}</ac:Value>
                    </ac:ContextItem>
                    <ac:ContextItem Name="DeviceName">
                        <ac:Value>{self.device_name}</ac:Value>
                    </ac:ContextItem>
                    <ac:ContextItem Name="MAC">
                        <ac:Value>{self.mac_address}</ac:Value>
                    </ac:ContextItem>
    ...
    def get_syncml_data(self, key):
        ...
        data = {
            ...
            f"./Device/DevDetail/HwV": {
                "Format": "chr",
                "Data": self.hw_version
            },
            f"./Device/DevDetail/DevTyp": {
                "Format": "chr",
                "Data": self.device_type_str
            },
            ...
            f"./Device/Vendor/MSFT/BitLocker/Status/DeviceEncryptionStatus": {
                "Format": "int",
                "Data": self.bitlocker_status
            },
            # ── Compliance CSP — self-reported, spoofable ─────────────────────
            f"./Vendor/MSFT/DeviceStatus/Compliance/EncryptionCompliance": {
                "Format": "int",
                "Data": self.encryption_compliance
            },
            f"./Vendor/MSFT/DeviceStatus/Firewall/Status": {
                "Format": "int",
                "Data": self.firewall_status
            },
            f"./Vendor/MSFT/DeviceStatus/Antivirus/Status": {
                "Format": "int",
                "Data": self.av_status
            },
            f"./Vendor/MSFT/DeviceStatus/Antivirus/SignatureStatus": {
                "Format": "int",
                "Data": self.av_signature_status
            },
            f"./Vendor/MSFT/DeviceStatus/Antispyware/Status": {
                "Format": "int",
                "Data": self.antispyware_status
            },
            f"./Vendor/MSFT/DeviceStatus/Antispyware/SignatureStatus": {
                "Format": "int",
                "Data": self.antispyware_sig_status
            },
            f"./Vendor/MSFT/DeviceStatus/TPM/SpecificationVersion": {
                "Format": "chr",
                "Data": self.tpm_version
            },
            f"./Vendor/MSFT/DeviceStatus/SecureBootState": {
                "Format": "int",
                "Data": self.secure_boot_state
            },
            f"./Vendor/MSFT/Defender/Health/DefenderEnabled": {
                "Format": "bool",
                "Data": self.defender_enabled
            },
            f"./Vendor/MSFT/Defender/Health/DefenderVersion": {
                "Format": "chr",
                "Data": self.defender_version
            },
            f"./Vendor/MSFT/Defender/Health/SignatureOutOfDate": {
                "Format": "bool",
                "Data": self.defender_sig_out_of_date
            },
            f"./Vendor/MSFT/Defender/Health/RtpEnabled": {
                "Format": "bool",
                "Data": self.defender_rtp_enabled
            },                                    
